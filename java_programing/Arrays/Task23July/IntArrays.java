...
public class IntArrays {
    ...
    public static void distEle(int[] arr, int n) {
        boolean[] check = new boolean[n];
    ...
    public static void dupliEle(int[] arr, int n) {
        boolean[] check = new boolean[n];
    ...
    public static void uniqEle(int[] arr, int n) {
        boolean[] check = new boolean[n];
    ...
    public static int firstMinFreqEle(int[] arr, int n) {
    ...
    public static int secondMinFreqEle(int[] arr, int n) {
    ...
    public static int thirdMinFreqEle(int[] arr, int n) {
    ...
    public static int firstMaxFreqEle(int[] arr, int n) {
    ...
    public static int secondMaxFreqEle(int[] arr, int n) {
    ...
    public static int thirdMaxFreqEle(int[] arr, int n) {
