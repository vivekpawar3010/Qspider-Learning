...
public class StringsSrrays {
	public static void main(String[] args) {
		String[] arr = { "java", "python", "java", "c", "python", "c", "c++", "java", "ruby" };
	...
	public static void freqEle(String[] arr, int n) {
	...
	public static void distEle(String[] arr, int n) {
		boolean[] check = new boolean[n];
	...
	public static void dupliEle(String[] arr, int n) {
		boolean[] check = new boolean[n];
	...
	public static void uniqEle(String[] arr, int n) {
		boolean[] check = new boolean[n];
	...
	public static String firstMinFreqEle(String[] arr, int n) {
	...
	public static String secondMinFreqEle(String[] arr, int n) {
	...
	public static String thirdMinFreqEle(String[] arr, int n) {
	...
	public static String firstMaxFreqEle(String[] arr, int n) {
	...
	public static String secondMaxFreqEle(String[] arr, int n) {
	...
	public static String thirdMaxFreqEle(String[] arr, int n) {
